...
%-----------------------------------------------------------------
\titleind{Basic Study of a Brushless DC Motor with Delta Winding}

\fullname{Fajar Andika}
...
\program{Mechanical Engineering Course}

\dept{Department of Engineering}

\firstsupervisor{Associate Professor Junichi Asama}
